...
add_wave -radix bin resetn
add_wave -radix bin -color "magenta" enable

add_wave_divider "m1 multipler"
add_wave -radix dec m1_op[0]
add_wave -radix dec m1_op[1]
add_wave -radix dec result[0]
add_wave -radix dec result_reg[0]

add_wave_divider "m2 multipler"
add_wave -radix dec m2_op[0]
add_wave -radix dec m2_op[1]
add_wave -radix dec result[1]
add_wave -radix dec result_reg[1]
